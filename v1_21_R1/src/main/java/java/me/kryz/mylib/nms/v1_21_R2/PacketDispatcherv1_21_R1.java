package java.me.kryz.mylib.nms.v1_21_R2;
...
import me.kryz.mylib.common.packet.PacketEvent;
import me.kryz.mylib.common.packet.PacketListener;
...
public class PacketDispatcherv1_21_R1 extends ChannelDuplexHandler {
    ...
    public PacketDispatcherv1_21_R1(final Logger logger, final UUID uuid, final String name) {
        this.logger = logger;
    ...
    public void channelRead(ChannelHandlerContext ctx, Object rawPacket) throws Exception {
        logger.info("[Packet-Interceptor] Starting to intercept packets for {}", playerName);
