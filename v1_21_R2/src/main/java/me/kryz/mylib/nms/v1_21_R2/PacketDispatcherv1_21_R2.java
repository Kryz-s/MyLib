...
public class PacketDispatcherv1_21_R2 extends ChannelDuplexHandler{
    ...
    public PacketDispatcherv1_21_R2(final Logger logger, final UUID uuid, final String name) {
        this.logger = logger;
